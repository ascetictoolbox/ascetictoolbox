...
package eu.ascetic.architecture.iaas.pac;
...
import eu.ascetic.architecture.iaas.pac.events.ViolationMessage;
import eu.ascetic.architecture.iaas.pac.events.converter.NodeWithAttributeConverter;
import eu.ascetic.architecture.iaas.pac.events.converter.ValueConverter;
...
public class ViolationMessageTranslator extends EventTranslator {
    ...
    public Message fromXML(String messageStr) {
        ...
        xstream.registerConverter(new eu.ascetic.architecture.iaas.pac.events.converter.DateTimeConverter());
