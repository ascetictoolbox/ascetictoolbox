...
package eu.ascetic.architecture.iaas.slamanager.poc.manager.resource;
...
public class OVFRetriever {
	...
	protected String configurationFilesPath = System.getenv("SLASOI_HOME") + System.getProperty("file.separator") + "ascetic-slamanager" + System.getProperty("file.separator")
