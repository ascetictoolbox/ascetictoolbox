...
public class OVFRetriever {
	...
	protected String configurationFilesPath = System.getenv("SLASOI_HOME") + System.getProperty("file.separator") + "ascetic-iaas-slamanager" + System.getProperty("file.separator")
