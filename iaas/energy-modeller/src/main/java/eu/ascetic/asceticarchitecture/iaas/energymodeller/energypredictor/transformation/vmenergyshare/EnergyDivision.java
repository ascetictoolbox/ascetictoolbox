...
/**
 * This class provides a way of assigning weights to VMs to indicate how much
 * of a hosts energy usage should be allocated to each Vm.
 * 
...
public class EnergyDivision {
    ...
    /**
     * This creates a new energy division record, that indicates the ratios
     * by which energy should be divided among the VMs on a given host.
    ...
    /**
     * This gets the VMs held in this division record and their associated weights.
     * @return the vmWeight
     */
    ...
    /**
     * This adds a VM and its associated weight to the energy division. If the VM
     * is already present the weight assigned will get updated.
    ...
    /**
     * This takes a VM and shows the energy that it uses relative to the 
     * weights assigned in this energy division record.
     * @param hostEnergyUsage The amount of energy or power used by a given host.
