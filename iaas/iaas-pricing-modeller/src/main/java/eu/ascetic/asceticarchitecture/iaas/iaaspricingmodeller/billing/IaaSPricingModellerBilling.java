...
import eu.ascetic.asceticarchitecture.iaas.iaaspricingmodeller.cost.IaaSPricingModellerCostInterface;
...
public class IaaSPricingModellerBilling implements IaaSPricingModellerBillingInterface {
	...
	static HashMap<Integer, VMstate> registeredStaticEnergyPricesVMs = new HashMap<Integer, VMstate>();
	static HashMap<Integer, VMstate> registeredDynamicEnergyPricesVMs = new HashMap<Integer, VMstate>();
	...
	public void registerVM(int VMid) {
	...
	public void updateAverageEnergyPrice() {
		...
		averageDynamicEnergyPrice.setPrice(scheme.updateAverageEnergyPrice(
				provider, averageDynamicEnergyPrice));
		...
		System.out.println("Bil: and the new dynamic price is "
				+ provider.getNewDynamicEnergyPrice().getPriceOnly());
	}
	...
	public void printStaticVMs() {
		for (int i : registeredStaticEnergyPricesVMs.keySet()) {
	...
	public void printDynamicVMs() {
		for (int i : registeredDynamicEnergyPricesVMs.keySet()) {
	...
	private VMstate getVM(int VMid) {
