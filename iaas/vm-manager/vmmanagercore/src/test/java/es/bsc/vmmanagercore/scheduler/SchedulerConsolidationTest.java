 ...
 *
 */
public class SchedulerConsolidationTest {
	
	private SchedulerConsolidation scheduler;
	...
	public void standardCaseWithThreeHosts() {
		...
		//83%, the load of host3 should be 75%, and host4 does not have enough available resources.
