...
import eu.ascetic.saas.applicationpackager.ide.wizards.XmlResponseAppManViewerWizardPage;
 ...
 * 
 */
public class AppManagerCallProgressBarDialog extends Dialog {
    ...
    private OvfResponseVmicViewerWizardPage currentWizardPage;
    private XmlResponseAppManViewerWizardPage nextWizardPage;
    
    private String ovfVmicResponse;
    private String inputOvf;
    private Application app;

	public AppManagerCallProgressBarDialog(Shell parent, 
			OvfResponseVmicViewerWizardPage currentWizardPage, 
			XmlResponseAppManViewerWizardPage nextWizardPage,
			String ovfCodeGeneratedByVmic) {
        super(parent);
        this.currentWizardPage = currentWizardPage;
        this.nextWizardPage = nextWizardPage;
        this.inputOvf = ovfCodeGeneratedByVmic;
    }
    ...
    public Object open() {
        ...
        shell.layout();
  	  	...
  	  	Job job = new Job("Application deployment in Application Manager from ASCETiC Application Packager") {
			@Override
    ...
    private void doExpensiveWork(final IProgressMonitor monitor) {
		...
		app = appManClient.postApplication(inputOvf, this);
...
//		ovfVmicResponse = vmicClient.testGenerateImageWorkflow(inputOvf, this);
    ...
    protected void createContents() {
		...
		this.setShellTitle("Paas Application Manager communication");
    ...
    protected void doAfter()
    {
		...
		if (app == null){				
			nextWizardPage.setErrorUploadingApp("ERROR retrieving XML from AppManager", this);	
		}
		else {
			nextWizardPage.setContent(app, this);
		}
