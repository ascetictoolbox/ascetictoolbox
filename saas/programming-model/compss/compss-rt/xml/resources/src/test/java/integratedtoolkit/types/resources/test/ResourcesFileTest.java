...
public class ResourcesFileTest {
	...
	public void resourceCreationTest() throws Exception {	
		...
		ResourceType worker = resources.addResource("res_1", "x86", new Float(2.5), new Integer(2),
				"Linux", new Float(2.5), new Float(2.5), new String[]{"Java"},new Integer(0),
				new String[]{"short"});
		...
		ResourceType worker_retrieved = resources2.getResource("res_1");
