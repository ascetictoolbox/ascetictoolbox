...
public class NIOTask implements Externalizable {
    ...
    public NIOTask(String lang, String installDir, String libPath, String appDir, String classPath, boolean workerDebug, String className, String methodName, boolean hasTarget, LinkedList<NIOParam> params, int numParams, int jobId, JobHistory hist, int transferGroupId) {
