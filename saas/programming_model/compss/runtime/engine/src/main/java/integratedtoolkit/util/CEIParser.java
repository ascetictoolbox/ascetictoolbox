...
public class CEIParser {
    ...
    /**
     * Treats and display possible warnings related to ONE annotation of the
     * Method/Service m
     *
     * @param m The method or service to be checked for warnings
     * @param type Type of the annotation
     * @param i Number of the annotation (0 for the first parameter, 1 for the
     * second, etc.)
     */
    ...
    public static LinkedList<Integer> loadJava(Class<?> annotItfClass) {
        ...
        for (java.lang.reflect.Method m : annotItfClass.getDeclaredMethods()) {
            ...
            if (m.isAnnotationPresent(Method.class)) {
                ...
                for (int i = 0; i < implementationCount; i++) {
                    loadMethodConstraints(methodId, implementationCount, signatures, declaringClasses, implConstraints);
                }
            } else { // Service 
                ...
                loadServiceConstraints(methodId, signature, serviceAnnot);
            }
        }
     ...
     */
    private static void loadServiceConstraints(int coreId, String coreSignature, Service service) {
     ...
     */
    private static void loadMethodConstraints(int coreId, int implementationCount, String[] implsSignatures, String[] declaringClasses, MethodResourceDescription[] cts) {
        ...
        CoreManager.registerImplementations(coreId, implementations, implsSignatures);
    }
    ...
    public static LinkedList<Integer> loadC(String constraintsFile) {
        ...
        for (int i = 0; i < coreCount; i++) {
            ...
            CoreManager.registerImplementations(i, implementations, new String[]{""});
        }
