...
public class WorkerStarter implements Runnable {
    ...
    public WorkerStarter(String name, MethodResourceDescription rd, HashMap<String, String> properties, HashMap<String, String> disks) {
        this.name = name;
        this.rd = rd;
    ...
    public void run() {
        ...
        Worker newResource;
        try {
            newResource = new MethodWorker(name, rd, null, properties, taskCount);
        } catch (Exception e) {
