#!/bin/bash
  ...
  sudo rm -f ${COMPSs_install_dir}/Monitor/apache-tomcat/webapps/compss-monitor.war 
  sudo rm -rf ${COMPSs_install_dir}/Monitor/apache-tomcat/webapps/compss-monitor
  ...
  echo "* Deploy"
  sudo cp ${script_dir}/../target/compss-monitor.war ${COMPSs_install_dir}/Monitor/apache-tomcat/webapps/ 
