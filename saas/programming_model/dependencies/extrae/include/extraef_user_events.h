...
C* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
C| @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/trunk/include/extraef_user_events.h $
C| @last_commit: $Date: 2014-07-31 13:13:47 +0200 (jue, 31 jul 2014) $
C| @version:     $Revision: 2907 $
C* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- 
