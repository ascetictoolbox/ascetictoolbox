...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/trunk/src/launcher/dyninst/mini-xml-parse.c $
 | @last_commit: $Date: 2013-02-27 14:47:01 +0100 (mié, 27 feb 2013) $
