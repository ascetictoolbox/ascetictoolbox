...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/trunk/src/merger/dimemas/misc_trf_semantics.c $
 | @last_commit: $Date: 2012-10-25 13:05:07 +0200 (jue, 25 oct 2012) $
