...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/trunk/src/merger/dimemas/dimemas_generator.c $
 | @last_commit: $Date: 2015-03-13 11:19:15 +0100 (vie, 13 mar 2015) $
