...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/trunk/tests/cross-compile-sizeof/check-sizeofs.c $
 | @last_commit: $Date: 2012-10-11 10:49:36 +0200 (jue, 11 oct 2012) $
