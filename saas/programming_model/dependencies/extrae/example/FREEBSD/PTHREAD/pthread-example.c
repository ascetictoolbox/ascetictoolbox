...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/trunk/example/FREEBSD/PTHREAD/pthread-example.c $
 | @last_commit: $Date: 2011-06-29 10:52:03 +0200 (mié, 29 jun 2011) $
