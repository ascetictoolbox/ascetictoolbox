...
public class LsfJob extends JobCpi {
    ...
    protected static Logger logger = LoggerFactory.getLogger(LsfJob.class);
    ...
    protected LsfJob(GATContext gatContext, JobDescription description,
            Sandbox sandbox) {
