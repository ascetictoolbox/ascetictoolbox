...
public class ApplicationMonitor {
    ...
    public static String startEvent(VM vm, String eventType) {
        ...
        try {
        	StringRequestEntity sre = new StringRequestEntity("{\"appId\":\"" + Configuration.getApplicationId() 
            		+ "\", \"nodeId\":\"" + vm.getProviderId() + "\", \"instanceId\":\"" + Configuration.getDeploymentId() 
            		+ "\", \"data\":{ \"ip\":\""+vm.getIPv4()+"\", \"eventType\":\""+eventType+"\"}}", "application/json", "UTF-8");
