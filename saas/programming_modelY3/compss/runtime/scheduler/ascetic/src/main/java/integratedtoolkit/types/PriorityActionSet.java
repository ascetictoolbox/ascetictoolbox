...
public class PriorityActionSet {
    ...
    public void offer(AllocatableAction action) {
        if (((AsceticSchedulingInformation) action.getSchedulingInfo()).isToReschedule()) {
    ...
    public AllocatableAction poll() {
        ...
        while ((currentPeek = priority.poll()) != null) {
            ...
            AsceticSchedulingInformation dsi = (AsceticSchedulingInformation) currentPeek.getSchedulingInfo();
    ...
    public AllocatableAction peek() {
        ...
        while (currentPeek != null
                && !((AsceticSchedulingInformation) currentPeek.getSchedulingInfo()).isToReschedule()) {
    ...
    public PriorityQueue<AllocatableAction> peekAll() {
        ...
        if (currentCore != null
                && !((AsceticSchedulingInformation) currentCore.getSchedulingInfo()).isToReschedule()) {
            noCoreActions.poll();
