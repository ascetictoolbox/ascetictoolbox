...
public class Random {
    ...
    /* ------------------------------------------------------------------------------
     ...
     ------------------------------------------------------------------------------ */
    /**
     * Initialises a sequence of uniformly distributed quasi random numbers with
    ...
    /**
     * Initialises a sequence of uniformly distributed quasi random numbers on a
     ...
     * a given seed.
     *
     * @param seed The seed of the random number generator. Two sequences with
    ...
    /**
     * This returns the next N random numbers in the sequence, as a vector.
     *
     * @param x
     */
