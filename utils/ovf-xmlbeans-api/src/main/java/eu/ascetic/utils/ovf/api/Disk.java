...
public class Disk extends AbstractElement<XmlBeanVirtualDiskDescType> {
    ...
    /**
     * Gets the unique identifier for this Disk referenced by the HostResource
     * element of {@link Item} in the following methods:<br>
     * <br>
    ...
    /**
     * Sets the unique identifier for this Disk referenced by the HostResource
     * element of {@link Item} in the following methods:<br>
     * <br>
     * {@link Item#addHostResource(String)}<br>
     * {@link Item#setHostResourceArray(String[])}<br>
