...
/**
 * Provides access to elements in the OperatingSystemSection of an OVF document.
 * This section specifies the operating system installed on a virtual machine
 * and is a valid section within a {@link VirtualSystem}.
 * 
...
public class OperatingSystem extends
    ...
    /**
     * Gets the ID of the operating system as a {@link OperatingSystemType}
     * representation.
     * 
    ...
    /**
     * Sets the ID of the operating system as a {@link OperatingSystemType}
     * representation.
     * 
     ...
     * 
     * @param description
     *            The human readable description to set
     */
