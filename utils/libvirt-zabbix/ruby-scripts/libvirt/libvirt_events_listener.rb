# Original code extracted from libvirt documentation examples
# Available here: https://libvirt.org/ruby/examples/event_test.rb
# Just copying the class definition of the files like they are... 
# modifying only the logging information to have a cleaner interface
# Modifications by david.garciaperez@atos.net
