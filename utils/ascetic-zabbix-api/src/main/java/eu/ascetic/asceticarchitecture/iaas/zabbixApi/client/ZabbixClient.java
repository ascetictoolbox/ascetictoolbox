...
public class ZabbixClient {
    ...
    private String createVM(String hostName, String ipAddress, HostGroup vmsHostGroup, Template vmTemplate) {
        /**
         * This static block prevents to instances of the Zabbix client from
         * adding a VM at the same time. This is done at class level instead of
         * at object level, in order to prevent multiple copies of a VM being 
         * added to Zabbix.
         */
        synchronized (ZabbixClient.class) {
            String newHostId = null;
            try {
    ...
    public String deleteVM(String hostName) {
        /**
         * This static block prevents to instances of the same client from
         * deleting a VM at the same time. This is done at class level instead of
         * at object level.
         */
        synchronized (ZabbixClient.class) {
