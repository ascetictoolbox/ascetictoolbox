...
public class JFuzzyChartImpl extends JFuzzyChart {
    ...
    public void chart(Defuzzifier def, String title, boolean showIt) {
        ...
        if (def.isDiscrete()) {
            chartDefuzzifierDiscrete((DefuzzifierDiscrete) def, title, showIt);
        } else {
            chartDefuzzifierContinuous((DefuzzifierContinuous) def, title, showIt);
        }
    }
    ...
    public void chart(MembershipFunction mf, String title, boolean showIt) {
        if (mf.isDiscrete()) {
            chartMembershipFunctionDiscrete((MembershipFunctionDiscrete) mf, title, showIt);
        } else {
            chartMembershipFunctionContinuous((MembershipFunctionContinuous) mf, title, showIt);
        }
    }
    ...
    public void chart(Variable var, Defuzzifier defuzzifier, boolean showIt) {
        ...
        if (defuzzifier.isDiscrete()) {
            chart = chartDefuzzifierDiscrete((DefuzzifierDiscrete) defuzzifier, title, false);
        } else {
            chart = chartDefuzzifierContinuous((DefuzzifierContinuous) defuzzifier, title, false);
        }
