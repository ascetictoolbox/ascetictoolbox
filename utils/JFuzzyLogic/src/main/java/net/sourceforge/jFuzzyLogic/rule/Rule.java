 ...
 * Fuzzy rule
 *
 * Rule:	If (x1 is termX1) AND (x2 is termX2) .... Then (y1 is termY1) AND (y2
 * is termY2) [weight: 1.0] Notes: - "If" clause is called "antecedent" - "then"
 * clause is called "consequent" - There may be 1 or more antecedents connected
 * using a 'RuleConnectionMethod' (e.g. AND, OR) - As there are many ways to
 * implement 'AND' and 'OR' connectors, you can customize them
 *
...
public class Rule extends FclObject implements CompileCpp {
    ...
    /**
     * Default constructor Default weight: 1.0 Default connection method: AND
     * (minimum)
     */
