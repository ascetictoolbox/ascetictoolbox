...
/**
 * Membership function that is a (simple) mathematical funcion (the result is a
 * singleton)
 *
...
public class MembershipFunctionFuncion extends MembershipFunctionDiscrete {
     ...
     * @return A tree of MffFunctions. Each leave can be either a function, a
     * value (Double), a Variable or a Variable's name.
     */
    ...
    /**
     * @see
     * net.sourceforge.jFuzzyLogic.membership.MembershipFunctionDiscrete#iterator()
     */
    @Override
    ...
    /**
     * @see
     * net.sourceforge.jFuzzyLogic.membership.MembershipFunctionDiscrete#membership(int)
     */
    @Override
