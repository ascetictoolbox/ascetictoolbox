...
/**
 * Membership function that is a (simple) mathematical function (Mff stands for
 * 'Membership Function type Function').
 *
 * Implements a mathematical function that depends on variables (should be input
 * variables only, to avoid some sort of 'race conditions').
 *
