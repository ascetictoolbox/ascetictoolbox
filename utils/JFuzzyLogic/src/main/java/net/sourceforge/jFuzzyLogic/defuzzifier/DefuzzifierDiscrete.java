...
/**
 * Generic discrete defuzzifier (a defuzzifier for continuous membership
 * functions)
 *
...
public abstract class DefuzzifierDiscrete extends Defuzzifier implements Iterable<Double> {
    ...
    /**
     * Funcion values: A generic discrete function x = [x_1, x_2, .... , x_n] y
     * = [y_1, y_2, .... , y_n] y_i = f[x_i] Values are stored in
     * 'discreteValues' hash
     */
