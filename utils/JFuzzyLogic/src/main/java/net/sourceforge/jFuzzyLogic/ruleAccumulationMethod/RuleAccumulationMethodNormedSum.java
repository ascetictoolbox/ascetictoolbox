...
public class RuleAccumulationMethodNormedSum extends RuleAccumulationMethod {
    ...
    /**
     * @see
     * net.sourceforge.jFuzzyLogic.ruleAccumulationMethod.RuleAccumulationMethod#aggregate(double,
     * double)
     */
    ...
    /**
     * @see
     * net.sourceforge.jFuzzyLogic.ruleAccumulationMethod.RuleAccumulationMethod#toStringFcl()
     */
