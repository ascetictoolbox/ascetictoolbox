 ...
 * From FCL's specs:
 *
 * "To fulfill de Morgan's Law, the algorithms for operators AND and OR shall be
 * used pair-wise e.g. MAX shall be used for OR if MIN is used for AND."
 *
 * Operator OR Operator AND MAX	MIN PROB_OR	PROD BSUM	BDIF
 *
