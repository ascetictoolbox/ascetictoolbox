 ...
 * a 'gradient' algorithm. Gradient optimization: Simply calculates gradient and
 * tries to optimize in that direction using a 'line search' algorithm.
 *
...
public class OptimizationGradient extends OptimizationPartialDerivate {
    ...
    /**
     * parameterList <=== parameterValues @param paramete
     *
     * rValues
     */
     ...
     * Estimate gradient
     *
     * @param portfolioOriginal Portfolio (estimate portfolioOriginal's gradient
     * to weigths)
