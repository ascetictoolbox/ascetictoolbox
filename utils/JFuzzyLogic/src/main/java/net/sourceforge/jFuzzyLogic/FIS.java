 ...
 *
 * A fuzzy logic inference system based on FCL language according to
 * "INTERNATIONAL ELECTROTECHNICAL COMMISSION" IEC 1131 - Part 7
 *
...
public class FIS extends FclObject implements Iterable<FunctionBlock>, CompileCpp {
    ...
    /**
     * Evaluate fuzzy rules all function blocks (in alphabetical order:
     * functionBlock.name)
     */
     ...
     * Get a FunctionBlock
     *
     * @param name : FunctionBlock's name (can be null to retrieve first
     * available one)
