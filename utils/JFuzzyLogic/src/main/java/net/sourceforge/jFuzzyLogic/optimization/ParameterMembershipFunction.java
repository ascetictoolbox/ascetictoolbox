...
/**
 * Representation of a parameter (that may be optimized using some optimization
 * algorithm) Membership funcion's parameter.
 *
...
public class ParameterMembershipFunction extends Parameter {
     ...
     * @param parameterIndex : Which parameter in that membership funcion we
     * refer
     */
