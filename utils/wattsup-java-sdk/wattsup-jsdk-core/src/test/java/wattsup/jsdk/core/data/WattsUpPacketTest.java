...
public class WattsUpPacketTest
{
     ...
     * 
     */
    private static final String measurement = "#d,-,18,965,1204,792,1,0,69384,5550,965,1205,833,965,1203,779,100,0,0,500,965;";

    @Test
    public void must_create_one_packet()
    {
        WattsUpPacket packet = WattsUpPacket.parser(measurement, Delimiter.COMMA, System.currentTimeMillis())[0];
