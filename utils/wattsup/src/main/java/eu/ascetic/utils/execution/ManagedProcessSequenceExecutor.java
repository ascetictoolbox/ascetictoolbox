...
import eu.ascetic.utils.ResultsStore;
import java.io.File;
...
public class ManagedProcessSequenceExecutor implements ManagedProcessListener {
    ...
    private final ManagedProcessLogger logger = new ManagedProcessLogger(new File("AppLog.csv"), false);
    private Actioner actioner = new Actioner();
    private int counter = 0;
    private Closeable sender;

    public ManagedProcessSequenceExecutor(Closeable closeable) {
