     ...
     public Object getClientData() {
        return clientData;
           ...
           public void receiveResultcreateAgreement(
                    eu.ascetic.paas.slam.poc.impl.provider.negotiation.ws.BZNegotiationStub.CreateAgreementResponse result
                        ) {
           }
           ...
           */
           ...
           public void receiveResultnegotiate(
                    eu.ascetic.paas.slam.poc.impl.provider.negotiation.ws.BZNegotiationStub.NegotiateResponse result
                        ) {
           }
           ...
           */
           ...
           public void receiveResultinitiateNegotiation(
                    eu.ascetic.paas.slam.poc.impl.provider.negotiation.ws.BZNegotiationStub.InitiateNegotiationResponse result
                        ) {
           }
           ...
           */
           ...
           public void receiveResultcancelNegotiation(
                    eu.ascetic.paas.slam.poc.impl.provider.negotiation.ws.BZNegotiationStub.CancelNegotiationResponse result
                        ) {
           }
           ...
           */
           ...
           public void receiveResultrenegotiate(
                    eu.ascetic.paas.slam.poc.impl.provider.negotiation.ws.BZNegotiationStub.RenegotiateResponse result
                        ) {
           }
           ...
           */
           ...
           public void receiveResultprovision(
                    eu.ascetic.paas.slam.poc.impl.provider.negotiation.ws.BZNegotiationStub.ProvisionResponse result
                        ) {
           }
           ...
           */
           ...
           public void receiveResultterminate(
                    eu.ascetic.paas.slam.poc.impl.provider.negotiation.ws.BZNegotiationStub.TerminateResponse result
                        ) {
           }
