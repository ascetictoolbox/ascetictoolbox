...
public class VMRestTest extends AbstractTest {
	...
	public void testGetEnergyEstimationForAVM() throws Exception {
		VMRest vmRest = new VMRest();
		...
		assertEquals("/applications/111/deployments/333/vms/444/energy-estimation", energyMeasurement.getHref());
		...
		assertEquals("/applications/111/deployments/333/vms/444/energy-estimation", energyMeasurement.getLinks().get(1).getHref());
	...
	public void testGetEnergyEstimationForAVMAndEvent() throws Exception {
		...
		List<String> ids = new ArrayList<String>();
		ids.add("2");
		when(energyModeller.estimate(null,  "111", "333", ids, "eventX", Unit.ENERGY, 3l)).thenReturn(22.0);
		//when(energyModeller.energyEstimation(null, "111", ids, "eventX")).thenReturn(22.0);
		
		Response response = vmRest.getEnergyEstimationForAnEvent("111", "333", "444", "eventX", 3l);
		assertEquals(200, response.getStatus());
	...
	public void testGetPowerEstimationForAVMAndEvent() throws Exception {
		...
		Response response = vmRest.getPowerEstimationForAnEvent("111", "333", "444", "eventX");
		assertEquals(200, response.getStatus());
	...
	@Test
	@SuppressWarnings(value = { "static-access" }) 
	public void testGetPowerEstimationForAVM() throws Exception {
		VMRest vmRest = new VMRest();
		PaaSEnergyModeller energyModeller = mock(PaaSEnergyModeller.class);
		vmRest.energyModeller = energyModeller;
		VMDAO vmDAO = mock(VMDAO.class);
		...
		List<String> ids = new ArrayList<String>();
		ids.add("2");
		when(energyModeller.estimate(null,  "111", "333", ids, null, Unit.POWER, 0l)).thenReturn(22.0);
		//when(energyModeller.energyEstimation(null, "111", ids, "eventX")).thenReturn(22.0);
		
		Response response = vmRest.getPowerEstimation("111", "333", "444");
		assertEquals(200, response.getStatus());
		...
		assertEquals("/applications/111/deployments/333/vms/444/power-estimation", powereasurement.getHref());
		assertEquals(22.0, powereasurement.getValue(), 0.00001);
		assertEquals("Aggregated power estimation in Wh for an event in a specific VM", powereasurement.getDescription());
		assertEquals(2, powereasurement.getLinks().size());
		assertEquals("/applications/111/deployments/333/vms/444", powereasurement.getLinks().get(0).getHref());
		assertEquals("parent", powereasurement.getLinks().get(0).getRel());
		assertEquals(MediaType.APPLICATION_XML, powereasurement.getLinks().get(0).getType());
		assertEquals("/applications/111/deployments/333/vms/444/power-estimation", powereasurement.getLinks().get(1).getHref());
		assertEquals("self",powereasurement.getLinks().get(1).getRel());
		assertEquals(MediaType.APPLICATION_XML, powereasurement.getLinks().get(1).getType());
	}
	...
	public void testGetEnergyConsumptionForAVMAndEvent() throws Exception {
		...
		Response response = vmRest.getEventEnergyConsumption("111", "333", "444", "eventX", 0, 0);
		assertEquals(200, response.getStatus());
	...
	public void testGetEnergyConsumptionForAVMAndEventStarTimeUntilNow() throws Exception {
		...
		Response response = vmRest.getEventEnergyConsumption("111", "333", "444", "eventX", 20l, 0l);
		assertEquals(200, response.getStatus());
	...
	public void testGetEnergyConsumptionForAVMAndEventStarTimeUntilSecondTime() throws Exception {
		...
		Response response = vmRest.getEventEnergyConsumption("111", "333", "444", "eventX", 20l, 33l);
		assertEquals(200, response.getStatus());
	...
	public void deleteVM() {
		...
		// We mock Energy Modeller
		PaaSEnergyModeller em = mock(PaaSEnergyModeller.class);
		...
		// verify em
		verify(em, times(1)).writeDeploymentRequest(null, "", "0", "0", "provider-id", "DELETED");
	...
	@Test
	public void postVMWithoutEnergyLimits() throws Exception {
		// We set a listener to get the sent message from the MessageQueue
		AmqpMessageReceiver receiver = new AmqpMessageReceiver(Configuration.amqpAddress, Configuration.amqpUsername, Configuration.amqpPassword,  "APPLICATION.>", true);
		AmqpListListener listener = new AmqpListListener();
		receiver.setMessageConsumer(listener);
		...
		agreement.setSlaAgreement(slaAgreementText);
	...
	@Test
	public void postNoRunningVMtoGetEnergyEstimation() throws Exception {
		// We set a listener to get the sent message from the MessageQueue
		AmqpMessageReceiver receiver = new AmqpMessageReceiver(Configuration.amqpAddress, Configuration.amqpUsername, Configuration.amqpPassword,  "APPLICATION.>", true);
		AmqpListListener listener = new AmqpListListener();
		receiver.setMessageConsumer(listener);
		...
		when(vmDAO.getVMsWithOvfIdAndActive(11, "haproxy")).thenReturn(new ArrayList<VM>());
	...
	@Test
	@SuppressWarnings(value = { "static-access" }) 
	public void postNoRunningVMSLAViolationOfMaximumVMLimit() throws Exception {
		// We set a listener to get the sent message from the MessageQueue
		AmqpMessageReceiver receiver = new AmqpMessageReceiver(Configuration.amqpAddress, Configuration.amqpUsername, Configuration.amqpPassword,  "APPLICATION.>", true);
		AmqpListListener listener = new AmqpListListener();
		receiver.setMessageConsumer(listener);
		...
		List<VM> vmsFromDB = new ArrayList<VM>();
		VM vm2 = new VM();
		vm2.setId(444);
		vm2.setProviderId("prod-id");
		vm2.setOvfId("haproxy");
		vmsFromDB.add(vm2);
		
		when(vmDAO.getVMsWithOvfIdAndActive(11, "haproxy")).thenReturn(vmsFromDB);
		when(vmDAO.getById(444)).thenReturn(vm2);
		
		// We mock the Energy Modeller
		PaaSEnergyModeller energyModeller = mock(PaaSEnergyModeller.class);
		List<String> ids = new ArrayList<String>();
		ids.add("444");
		when(energyModeller.estimate("prod-id",  "threeTierWebApp", "11", ids, null, Unit.POWER, 0l)).thenReturn(60.0);
		...
		assertEquals("Over the limit of the SLA agreement per this VM type... !!!", (String) response.getEntity());
	...
	@Test
	@SuppressWarnings(value = { "static-access" }) 
	public void postNoRunningVMSLAViolationOfMaximumAppLimit() throws Exception {
		// We set a listener to get the sent message from the MessageQueue
		AmqpMessageReceiver receiver = new AmqpMessageReceiver(Configuration.amqpAddress, Configuration.amqpUsername, Configuration.amqpPassword,  "APPLICATION.>", true);
		AmqpListListener listener = new AmqpListListener();
		receiver.setMessageConsumer(listener);
		...
		VM vmD1 = new VM();
		vmD1.setId(111);
		vmD1.setStatus(STATE_VM_ACTIVE);
		VM vmD2 = new VM();
		vmD2.setId(222);
		vmD2.setStatus(STATE_VM_ACTIVE);
		
		deployment.addVM(vmD1);
		deployment.addVM(vmD2);
		...
		List<String> ids = new ArrayList<String>();
		ids.add("444");
		when(energyModeller.estimate("prod-id",  "threeTierWebApp", "11", ids, null, Unit.POWER, 0l)).thenReturn(5.0);
		
		List<String> ids2 = new ArrayList<String>();
		ids2.add("111");
		ids2.add("222");
		when(energyModeller.estimate("prod-id",  "threeTierWebApp", "11", ids2, null, Unit.POWER, 0l)).thenReturn(140.0);
		...
		Response response = vmRest.postVM("threeTierWebApp", "11", false, vmRequest);
		assertEquals(403, response.getStatus());
		assertEquals("Over the limit of the SLA agreement per application... !!!", (String) response.getEntity());
	...
	@Test
	@SuppressWarnings(value = { "static-access" }) 
	public void postVMInsideSLALimits() throws Exception {
		// We set a listener to get the sent message from the MessageQueue
		AmqpMessageReceiver receiver = new AmqpMessageReceiver(Configuration.amqpAddress, Configuration.amqpUsername, Configuration.amqpPassword,  "APPLICATION.>", true);
		AmqpListListener listener = new AmqpListListener();
		receiver.setMessageConsumer(listener);
		...
		ids2.add("111");
		ids2.add("222");
		when(energyModeller.estimate("prod-id",  "threeTierWebApp", "11", ids2, null, Unit.POWER, 0l)).thenReturn(5.0);
		...
		ArgumentCaptor<Deployment> deploymentCaptor = ArgumentCaptor.forClass(Deployment.class);
		verify(deploymentDAO, times(1)).update(deploymentCaptor.capture());
		assertEquals(3, deploymentCaptor.getValue().getVms().size());
		assertEquals("haproxy", deploymentCaptor.getValue().getVms().get(2).getOvfId());
		assertEquals("10.0.0.1", deploymentCaptor.getValue().getVms().get(2).getIp());
		assertEquals("haproxy-vm1", deploymentCaptor.getValue().getVms().get(2).getProviderVmId());
		assertEquals("prod-id", deploymentCaptor.getValue().getVms().get(2).getProviderId());
	...
	@Test
	public void postVMOverNumberCPU() throws Exception {
		// We set a listener to get the sent message from the MessageQueue
		AmqpMessageReceiver receiver = new AmqpMessageReceiver(Configuration.amqpAddress, Configuration.amqpUsername, Configuration.amqpPassword,  "APPLICATION.>", true);
		AmqpListListener listener = new AmqpListListener();
		receiver.setMessageConsumer(listener);
		...
		List<Vm> vms1 = new ArrayList<Vm>();
		VmWithEquals vm1e = new VmWithEquals("HAProxy_2","haproxy-uuid",1,512,20, 0,"/DFS/ascetic/vm-images/threeTierWebApp/haproxy.iso_2","threeTierWebApp", "haproxy", "", false);
		System.out.println("VM with equals: " + vm1e);
		vms1.add(vm1e);
		List<String> ids1 = new ArrayList<String>();
		ids1.add("haproxy-vm1");
	...
	@Test
	public void postVMRightNumberCPU() throws Exception {
		// We set a listener to get the sent message from the MessageQueue
		AmqpMessageReceiver receiver = new AmqpMessageReceiver(Configuration.amqpAddress, Configuration.amqpUsername, Configuration.amqpPassword,  "APPLICATION.>", true);
		AmqpListListener listener = new AmqpListListener();
		receiver.setMessageConsumer(listener);
		...
		List<Vm> vms1 = new ArrayList<Vm>();
		VmWithEquals vm1e = new VmWithEquals("HAProxy_2","haproxy-uuid",2,512,20, 0,"/DFS/ascetic/vm-images/threeTierWebApp/haproxy.iso_2","threeTierWebApp", "haproxy", "", false);
		System.out.println("VM with equals: " + vm1e);
		vms1.add(vm1e);
		List<String> ids1 = new ArrayList<String>();
		ids1.add("haproxy-vm1");
