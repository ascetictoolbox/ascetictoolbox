 ...
 * 
 * Model class that represents the Expr tag in an SLA Template xml document
 *
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "Expr", namespace = SLA_XMLNS)
public class Expr {
	@XmlElement(name = "ValueExpr", namespace = SLA_XMLNS)
