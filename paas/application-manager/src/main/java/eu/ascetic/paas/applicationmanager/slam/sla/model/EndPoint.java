 ...
 * 
 * Represents the EndPoint entry inside an SLA Template
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name="Endpoint", namespace=SLA_XMLNS)
public class EndPoint {
	@XmlElement(name="Properties", namespace=SLA_XMLNS)
	private Properties properties;
	@XmlElement(name="ID", namespace=SLA_XMLNS)
	private String id;
	@XmlElement(name="Location", namespace=SLA_XMLNS)
	private String location;
	@XmlElement(name="Protocol", namespace=SLA_XMLNS)
