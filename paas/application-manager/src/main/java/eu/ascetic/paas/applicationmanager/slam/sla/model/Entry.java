 ...
 * 
 * This class represents a key-value entry in the negotiation agreement with
 * the PaaS SLAM 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "Entry", namespace = SLA_XMLNS)
public class Entry {
	@XmlElement(name = "Key", namespace = SLA_XMLNS)
	private String key;
