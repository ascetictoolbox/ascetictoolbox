...
class AppMeasuresNotifier implements PeriodicNotifier {
    ...
    public AppMeasuresNotifier(SessionHolder sessionHolder, String appId, String deploymentId, String slaId, String[] terms, long frequency, long period) throws PeriodicNotificationException {
        ...
        try {
            ...
            this.period = period;
            this.topicName = TOPIC_PREFIX + appId + TOPIC_SUFFIX;
            this.topicKey = "topic." + appId;
            ...
            if (appId != null) {
                ...
                if (deploymentId != null || slaId != null) {
                    sb.append("AND ");
                }
            }
            ...
            if (slaId != null) {
                sb.append(EventsDBMapper.SLA_ID).append(" = '").append(slaId).append("' ");
            }
    ...
    private MessageProducer createProducer() throws IOException, NamingException, JMSException {
        ...
        return sessionHolder.getSession().createProducer(topic);
    }
    ...
    public void sendNotification() throws PeriodicNotificationException {
        ...
        try {
            ...
            if (an != null && an.size() > 0) {
                Logger.debug("Received: " + an.toString());
                for (JsonNode jn : an) {
                    ...
                    TextMessage responseMessage = sessionHolder.getSession().createTextMessage(responseStr);
