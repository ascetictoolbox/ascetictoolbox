...
CREATE TABLE IF NOT EXISTS APPLICATION_REGISTRY ( app_id varchar(25) NOT NULL, deploy_id INT NOT NULL, vm_id INT NOT NULL, iaas_id varchar(50), start BIGINT, stop BIGINT, profile_id INT,   model_id INT,   PRIMARY KEY (app_id,deploy_id,vm_id));