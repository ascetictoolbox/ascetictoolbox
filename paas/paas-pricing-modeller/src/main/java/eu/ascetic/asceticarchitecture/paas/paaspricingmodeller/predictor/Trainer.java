 ...
 * the License.
 */
package eu.ascetic.asceticarchitecture.paas.paaspricingmodeller.predictor;
...
public class Trainer {
   ...
   public static HashMap<AppState, Double> storeValues = new HashMap<>();
    ...
    public boolean trainModel(AppState app, double energyCalculated, double IaaSCharges) {
      /*  int num = 0;
        if (storeValues.containsKey(app)) {
            temp = storeValues.get(app);
            temp.add(usageHost);
