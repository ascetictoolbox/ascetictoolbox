...
public class TimeParameters {
  ...
  //  private Calendar lastChange;
    ...
    public TimeParameters (){
    	...
    	//System.out.println("Time parameter: start time " +startTime.getTimeInMillis());
    	this.endTime = Calendar.getInstance();
    	//System.out.println("Time parameter: End time " +endTime.getTimeInMillis());
   ...
   /* public void setStartTime(){
    ...
    public void setEndTime(long endTime){
    	  this.endTime = new GregorianCalendar();
          this.endTime.setTimeInMillis(TimeUnit.SECONDS.toMillis(endTime));
       //   System.out.println("Time parameters: start time = "+ startTime.getTimeInMillis());
        //  System.out.println("Time parameters: end time = "+ this.endTime.getTimeInMillis());
    }
    /**
     * The start time for the duration the query represents.
     *
