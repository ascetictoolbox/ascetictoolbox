    ...
    public void testContextualizeServiceWorkflow() {
        ...
        try {
            ...
            if (testOvfDefinition != null) {
                ...
                // Generate a default OVF doc here
                ovfDefinition = OvfDefinition.Factory.newInstance(
                        "threeTierWebApp",
                        "/DFS/ascetic/vm-images/threeTierWebApp");
            }
            ...
            while (true) {
                try {
                    ...
                    vmcApi.contextualizeServiceCallback(ovfDefinition
            ...
            while (true) {
                ...
                progressData = vmcApi
                        .contextualizeServiceCallback(ovfDefinition
                                .getVirtualSystemCollection().getId());
            ...
            OvfDefinition ovfDefinition2 = vmcApi
            ...
            if (Integer.parseInt(args[0]) == 1) {
                ...
                if (args.length == 1) {
                    ...
                    if (args.length == 3) {
                        ...
                        try {
                            doc = XmlBeanEnvelopeDocument.Factory.parse(smFile);
                ...
                // Performance Evaluation (Option 2)
                ...
                // Recontextualization (Option 3)
                System.out
                        .println("Running the VMC in Recontextualization Mode...");
                ...
                if (args.length == 5) {
                    ...
                    // TODO at some point put/get this in the properties file
                    log.info("Using Hypervisor URI: " + args[3]);
                    // TODO at some point put/get this in the properties file
                    log.info("Using VM Name: " + args[4]);

                    vmcApiRecontextTest.recontextualize(configFilePath, true,
                            args[3], args[4]);
                } else {
