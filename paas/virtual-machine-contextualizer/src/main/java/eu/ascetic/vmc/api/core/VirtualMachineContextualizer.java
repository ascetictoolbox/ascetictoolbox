...
public class VirtualMachineContextualizer implements Runnable {
     ...
     *            The OVF Definition.
     */
    public VirtualMachineContextualizer(VmcApi vmcApi,
     ...
     */
    public VirtualMachineContextualizer(VmcApi vmcApi,
            OvfDefinition ovfDefinition, String imageFormat) {
        this.vmcApi = vmcApi;
        this.ovfDefinition = ovfDefinition;
    ...
    private void convertVmImages() throws SystemCallException {
        ...
        if (imageFormat != null) {
            ...
            for (VirtualMachine virtualMachine : virtualMachines.values()) {
                ...
                // TODO: OVF Definition only supports a single image per
                // component?
    ...
    private void createIsoImages() throws SystemCallException {
        ...
        // TODO: Maybe store this when gathering context data from the
        // ovfDefinition?
        for (VirtualMachine virtualMachine : virtualMachines.values()) {
        ...
        for (VirtualMachine virtualMachine : virtualMachines.values()) {
            ...
            for (int i = 1; i <= virtualMachine.getUpperBound(); i++) {
                ...
                String isoFileName = virtualMachine.getComponentId() + ".iso"
                        + "_" + i;
        ...
        OvfDefinitionClient ovfDefinitionClient = new OvfDefinitionClient(
                ovfDefinition);
        ovfDefinition = ovfDefinitionClient
                .addIsosToOvfDefinition(virtualMachines);
    }
}
