...
/**
 * Implementation of the core API providing access to VM Contextualizer
 * functionality
 * 
...
public class VmcApi implements Api {
    ...
    protected static final Logger LOGGER = Logger.getLogger(VmcApi.class);
     ...
     * 
     * @see
     * eu.ascetic.vmc.api.Api#contextualizeService(eu.ascetic.utils.ovf.api.
     * OvfDefinition)
     */
     ...
     * OvfDefinition containing the details of the service to be contextualized,
     * this function performs a number of operations asynchronously.
     * 
     * @param ovfDefinition
     ...
     * 
     * @see
     * eu.ascetic.vmc.api.Api#contextualizeServiceCallback(java.lang.String)
     */
    ...
    /**
     * Given a OVF definition ID, wait for the associated contextualization
     * thread to exit. This should only be used when performing serialised unit
     * tests for the purpose of improving logger readability.
     * 
     * @param ovfDefinitionId
     *            Contextualize thread for a given OVF Definition ID to wait
     *            for.
     */
    ...
    public void startRecontext(String domainName) {
        if (virtualMachineRecontextualizer != null) {
            try {
                virtualMachineRecontextualizer
                        .startRecontextualization(domainName);
            } catch (IOException e) {
                LOGGER.error(
                        "Failed to start Recontextualizer on specific domain",
                        e);
            }
        }
    }
