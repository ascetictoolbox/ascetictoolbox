...
public class LibvirtControlBridge implements LibvirtControlBridgeMBean {
     ...
     * 
     * @see
     * eu.ascetic.vmc.api.core.libvirt.LibvirtControlBridgeMBean#attachIso(java
     ...
     * 
     * @see
     * eu.ascetic.vmc.api.core.libvirt.LibvirtControlBridgeMBean#detachIso(java
     ...
     * 
     * @param isoPath
     *            The iso file path to attach (may be null when detaching)
     * @param interFaceName
     *            The name of the interface where the ISO should be
     * @param attaching
     *            True when attaching, false when detaching
     ...
     * 
     * @see
     * eu.ascetic.vmc.api.core.libvirt.LibvirtControlBridgeMBean#getExistingIsoPath
